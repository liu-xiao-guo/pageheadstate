...
UBUNTU_TRANSLATION_DOMAIN="pageheadstate.liu-xiao-guo"
...
aptest.commands = bash $$PWD/pageheadstate/tests/autopilot/run
aptest.depends  = sub-pageheadstate

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/pageheadstate/tests/unit
unittest.depends  = sub-pageheadstate
